<aside class="w-64 bg-white border-r border-slate-200 shadow-sm hidden md:flex flex-col h-full text-left">
    <div class="p-4 space-y-1 flex-1 overflow-y-auto">
        ...
        @if($user?->isAdmin())
        <div class="pt-3 pb-1">
            <span class="px-4 text-[10px] font-bold text-slate-400 uppercase tracking-wider">Gestion de la plateforme</span>
        </div>
