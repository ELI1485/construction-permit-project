...
@section('title', 'Espace architecte - ma licence')
...
<div class="max-w-6xl mx-auto space-y-8">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
            ...
            <p class="text-slate-500 text-sm">Espace architecte — Suivre les projets et soumettre les plans.</p>
        </div>
        <a href="{{ route('permits.create') }}"
           class="inline-flex items-center gap-2 bg-[#006399] text-white px-5 py-2.5 rounded-xl font-bold hover:bg-[#005180] transition-colors shadow-md shadow-blue-200 text-sm">
            ...
            Téléchargez un nouveau fichier de projet
        </a>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 border-r-4 border-r-[#006399]">
            <p class="text-slate-500 text-sm font-medium mb-1">Projets en tant qu'ingénieur</p>
        ...
        <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 border-r-4 border-r-amber-400">
            <p class="text-slate-500 text-sm font-medium mb-1">À l'étude</p>
        ...
        <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 border-r-4 border-r-emerald-400">
            <p class="text-slate-500 text-sm font-medium mb-1">acceptable</p>
            <h3 class="text-3xl font-extrabold text-slate-800">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
        <div class="p-6 border-b border-slate-100 flex items-center justify-between">
            <h3 class="font-bold text-slate-800 text-lg">Mes dossiers en tant qu'architecte</h3>
            <span class="text-xs font-bold px-3 py-1 rounded-full bg-slate-100 text-slate-600">{{ $permits->total() }} déposer</span>
        </div>
        ...
        @else
            <div class="p-12 text-center text-slate-400 space-y-3">
                ...
                <p class="font-medium">Il n'y a pas encore de fichiers associés à votre compte</p>
                <a href="{{ route('permits.create') }}" class="inline-block text-xs text-[#006399] font-bold underline hover:text-blue-800">Commencez par déposer votre premier dossier</a>
            </div>
        @endif
    </div>
