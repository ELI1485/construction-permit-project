...
<div class="mb-6 flex items-center justify-between">
    <div class="flex items-center gap-4">
        ...
        <h1 class="text-xl font-bold text-slate-800">Plan d'ingénierie du projet.pdf</h1>
    </div>
...
<div class="bg-slate-200 rounded-2xl shadow-inner h-[80vh] flex items-center justify-center relative overflow-hidden">
    ...
    <span class="relative z-10 text-slate-500 font-medium">L'aperçu du document n'est pas disponible sous ce formulaire</span>
</div>
@endsection
