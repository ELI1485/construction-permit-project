        ...
        <div class="flex justify-between items-center h-16">
            ...
            <div class="flex-shrink-0 flex items-center gap-2.5">
                <a href="{{ route('dashboard') }}" class="flex items-center gap-2.5 group">
                    <img src="{{ asset('images/logo.png') }}" alt="Logo Rokhsati"
                         class="w-10 h-10 object-contain group-hover:scale-105 transition-transform" />
                    <div class="flex flex-col leading-tight">
                        <span class="text-xl font-extrabold text-[#006399] tracking-tight leading-none">ROKHSATI</span>
            ...
            <div class="flex items-center gap-3">
                <!-- Notification Bell -->
                <a href="{{ route('notifications.index') }}" class="relative p-2 text-slate-500 hover:text-[#006399] transition-colors rounded-lg hover:bg-blue-50" title="Notifications">
                ...
                <div class="relative" x-data="{ open: false }" @click.outside="open = false">
                    <button @click="open = !open"
                        ...
                        <div class="hidden sm:flex flex-col items-start leading-tight text-left">
                            ...
                            <span class="text-[10px] text-slate-400 font-medium">{{ auth()->user()?->role?->nom ?? 'Utilisateur' }}</span>
                        </div>
                    ...
                    <div x-show="open" x-transition
                         class="absolute right-0 mt-2 w-52 bg-white rounded-xl shadow-lg border border-slate-100 py-1 z-50 text-left">
