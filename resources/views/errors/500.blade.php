...
<body>
    <div class="text-center">
        ...
        <h1 class="fw-bold" style="color:#1B3A5C;">500</h1>
        <h4 class="text-muted mb-3">Erreur interne du serveur</h4>
        <p class="text-muted mb-4">Une erreur inattendue s'est produite. Veuillez réessayer plus tard.</p>
