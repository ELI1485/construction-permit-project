...
<div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
    <div>
        <h1 class="text-2xl font-bold text-slate-800 mb-1">Bibliothèque documentaire</h1>
        <p class="text-slate-500 text-sm">Gérer et parcourir tous les documents joints aux candidatures.</p>
    </div>
...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6">
    ...
    <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 hover:shadow-md transition-shadow group cursor-pointer">
        ...
        <h3 class="font-bold text-slate-800 mb-1">Plan d'ingénierie du projet</h3>
        <p class="text-xs text-slate-500 mb-4">PDF • 2.4 MB • Il y a deux jours</p>
        <div class="flex items-center gap-2">
            <button class="flex-1 bg-slate-50 text-slate-600 py-2 rounded-lg font-medium hover:bg-slate-100 transition-colors text-sm">une offre</button>
            <button class="flex-1 bg-blue-50 text-blue-600 py-2 rounded-lg font-medium hover:bg-blue-100 transition-colors text-sm">télécharger</button>
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 hover:shadow-md transition-shadow group cursor-pointer">
        ...
        <h3 class="font-bold text-slate-800 mb-1">Photos des sites</h3>
        <p class="text-xs text-slate-500 mb-4">JPG • 4.1 MB • Il y a une semaine</p>
        <div class="flex items-center gap-2">
            <button class="flex-1 bg-slate-50 text-slate-600 py-2 rounded-lg font-medium hover:bg-slate-100 transition-colors text-sm">une offre</button>
            <button class="flex-1 bg-blue-50 text-blue-600 py-2 rounded-lg font-medium hover:bg-blue-100 transition-colors text-sm">télécharger</button>
        </div>
