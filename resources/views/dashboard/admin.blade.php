...
@section('title', 'Tableau de bord administratif - ma licence')
...
<div class="max-w-6xl mx-auto space-y-8">
    ...
    {{-- Header --}}
    <div>
        <h1 class="text-2xl font-extrabold text-slate-800 mb-1">Tableau de bord — Administration centrale</h1>
        <p class="text-slate-500 text-sm">Un aperçu complet des performances de la plateforme Rakhsati et de l'état des dossiers.</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 flex items-center gap-4">
            ...
            <div>
                <p class="text-slate-500 text-sm font-medium">Nombre total d'utilisateurs</p>
        ...
        <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 flex items-center gap-4">
            ...
            <div>
                <p class="text-slate-500 text-sm font-medium">Total des commandes</p>
        ...
        <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 flex items-center gap-4">
            ...
            <div>
                <p class="text-slate-500 text-sm font-medium">Dossiers à haut risque</p>
        ...
        <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 flex items-center gap-4">
            ...
            <div>
                <p class="text-slate-500 text-sm font-medium">Types de cas</p>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
        <h3 class="text-lg font-bold text-slate-800 mb-6">Répartition des demandes selon la situation</h3>
        @if($byStatus->count() > 0)
        ...
        @else
            <p class="text-slate-400 text-sm text-center py-6">Il n'y a pas de données actuellement.</p>
        @endif
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <a href="{{ route('users.index') }}" class="group bg-white border border-slate-200 rounded-2xl p-5 shadow-xs hover:border-[#006399] hover:shadow-md transition-all flex items-center gap-4">
            ...
            <div>
                <p class="font-bold text-slate-800 text-sm">Gestion des utilisateurs</p>
                <p class="text-xs text-slate-400 mt-0.5">Rôles et pouvoirs</p>
            </div>
        </a>
        <a href="{{ route('admin.statistics') }}" class="group bg-white border border-slate-200 rounded-2xl p-5 shadow-xs hover:border-[#006399] hover:shadow-md transition-all flex items-center gap-4">
            ...
            <div>
                <p class="font-bold text-slate-800 text-sm">Statistiques détaillées</p>
                <p class="text-xs text-slate-400 mt-0.5">Rapports de performances mensuels</p>
            </div>
        </a>
        <a href="{{ route('admin.archives') }}" class="group bg-white border border-slate-200 rounded-2xl p-5 shadow-xs hover:border-[#006399] hover:shadow-md transition-all flex items-center gap-4">
            ...
            <div>
                <p class="font-bold text-slate-800 text-sm">archives</p>
                <p class="text-xs text-slate-400 mt-0.5">Fichiers archivés et expirés</p>
            </div>
        </a>
    </div>
